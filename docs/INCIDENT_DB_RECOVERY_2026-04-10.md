...
**Вероятная причина класса:** подмена/откат файла `magikbook.db` или работа не с тем инстансом; `*.db` не в git — восстановление только с хоста/бэкапов/ручной правкой.
